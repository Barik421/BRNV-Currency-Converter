...
const translations = {
  en: {
    ...
    metaDescription: "Convert EUR, USD, UAH, HUF, GBP, PLN and other European currencies with BRNV Currency Converter. Fast live exchange rates for travel, work and crypto conversion.",
  ...
  uk: {
    ...
    metaDescription: "Конвертуйте EUR, USD, UAH, HUF, GBP, PLN та інші європейські валюти з BRNV Конвертером валют. Швидкий конвертер із живими курсами для подорожей, роботи та криптовалют.",
